 ...
 */
public class MODIFIER_INFOS_ENTREPRISE extends javax.swing.JFrame {

    /**
     * Creates new form Index
     */
    public MODIFIER_INFOS_ENTREPRISE() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Veuillez remplir les formulaires pour modifier les informations de l'entreprise");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MODIFIER_INFOS_ENTREPRISE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MODIFIER_INFOS_ENTREPRISE().setVisible(true);
            }
        });
    }
